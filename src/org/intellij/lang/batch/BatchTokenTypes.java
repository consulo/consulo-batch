...
public interface BatchTokenTypes
{
	...
	TokenSet KEYWORDS = TokenSet.create(ECHO_KEYWORD, GOTO_KEYWORD, CALL_KEYWORD, IF_KEYWORD, EXIST_KEYWORD, NOT_KEYWORD, DEFINED_KEYWORD, FOR_KEYWORD, IN_KEYWORD, DO_KEYWORD, ERRORLEVEL_KEYWORD, ON_KEYWORD, OFF_KEYWORD, ELSE_KEYWORD, SET_KEYWORD, CMDEXTVERSION_KEYWORD);

	TokenSet OPERATORS = TokenSet.create(EQUAL_OPERATOR, OR_OPERATOR, AND_OPERATOR, PIPE_OPERATOR, APPEND_OPERATOR, PUT_OPERATOR, GET_OPERATOR);
